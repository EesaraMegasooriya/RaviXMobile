...
try {
  ...
  const { product } = await request('/admin/products', 'POST', { brand: 'Smoke', name: 'Test earbuds', category: category.name, price: 1500, rating: 4, img: 'https://example.com/product.png', isActive: true }, 201);
